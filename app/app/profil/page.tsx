      ...
      <div className="mt-10 grid gap-8 lg:grid-cols-[1.5fr_1fr]">
        ...
        <aside className="space-y-5">
          ...
          <div className="rounded-lg border border-(--color-line) bg-(--color-paper) p-5">
            ...
            <button className="mt-4 inline-flex items-center justify-center rounded-md border border-(--color-line) px-4 py-2 text-sm font-medium text-(--color-ink) hover:border-(--color-ink)">
              Atur visibilitas
            </button>
          </div>
        </aside>
